...
class ModInputpihole_cache(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputpihole_cache, self).__init__(
...
if __name__ == "__main__":
    exitcode = ModInputpihole_cache().run(sys.argv)
    sys.exit(exitcode)
